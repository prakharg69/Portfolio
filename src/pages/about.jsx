...
const data = {
  ...
  about: {
    summary:
      "I am a 3rd-year B.Tech CSE student at Lovely Professional University with a CGPA of 7.3. I have a strong interest in web development and enjoy building modern, scalable applications using frontend and backend technologies.",
    interests: [
      "Web Development",
      "UI/UX Design",
...
const BentoLayout = ({
  ...
  const contributions = Array.from({ length: 365 }).map(() =>
  ...
  group-hover:scale-110`}
        ...
        >
          ...
          >
            ...
            />
            <motion.div className="absolute inset-0 rounded-full border-t-2 border-green-500" />
          </motion.div>
          <div className="flex-1 min-w-0">
            ...
            <div className="w-full bg-gray-700 h-1.5 rounded-full overflow-hidden">
              <motion.div className="bg-green-500 h-full rounded-full" />
            </div>
          </div>
        </BentoCard>
        ...
        >
          ...
          <h2 className="array-font text-4xl font-bold text-white leading-none">
            {time.getDate()}
          </h2>
        ...
        >
          ...
          <p className="text-[8px] text-gray-400 mt-3 font-mono">
            — Cory House
          </p>
        </BentoCard>
        ...
        >
          ...
          {/* Scrollable List */}
         <div className="flex-1 pr-2 space-y-3 relative z-10">
    ...
    <div className="w-full h-full flex flex-col md:flex-row overflow-hidden relative">
      ...
      <div className="w-full md:w-2/3 h-full overflow-y-auto p-8 md:p-12 lg:p-16 relative">
        <div className="hidden md:block mb-12 border-b-2 border-dotted border-gray-700 pb-8">
          <h1 className="array-font text-6xl font-bold text-white tracking-tighter mb-2">
            {data.personalInfo.name}
          </h1>
          ...
          <div className="flex gap-6 mt-4 text-xs text-gray-500 font-mono items-center">
            <span className="flex items-center gap-2">
              <FaMapMarkerAlt /> {data.personalInfo.university}
            </span>
            <span className="flex items-center gap-2">
              <FaGraduationCap /> {data.personalInfo.year}
            </span>
            <span className="flex items-center gap-2">
              <FaAward /> CGPA: {data.personalInfo.cgpa}
            </span>
          </div>
        </div>
        <div className="mb-16">
    ...
    <>
      <section className="grid-bg h-screen w-full relative overflow-hidden">
        ...
        <div className="absolute top-24 right-6 z-20 flex flex-col gap-2">
          <span className="text-[10px] text-gray-500 font-mono tracking-widest uppercase text-right mb-1">
            View Layout
          </span>
          <button
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {layout === "minimal" && (
              <MinimalLayout data={data} iconMap={iconMap} />
            )}
            {layout === "magazine" && (
              <MagazineLayout data={data} iconMap={iconMap} />
            )}
          </motion.div>
        </AnimatePresence>
      </section>
