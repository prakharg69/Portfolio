      ...
      <section className="grid-bg min-h-screen flex items-center justify-center text-white relative overflow-hidden px-4">
        ...
        <div className="text-center">
          ...
          <div className="flex flex-wrap md:flex-nowrap items-center justify-center gap-2 md:gap-4 whitespace-nowrap">
            ...
            <h1 className="array-font text-2xl sm:text-5xl md:text-7xl lg:text-6xl font-bold tracking-tight">
              CRAFTING DIGITAL
            </h1>
            ...
            <AnimatePresence mode="wait">
              <motion.h1
                ...
                className="array-font text-2xl sm:text-5xl md:text-7xl lg:text-6xl font-extrabold text-blue-500 tracking-tight"
              >
                {words[index]}
              </motion.h1>
            </AnimatePresence>
          ...
          {/* LINE 2 */}
          <h1 className="array-font text-3xl sm:text-5xl md:text-7xl lg:text-6xl font-bold tracking-tight mt-4 md:mt-6">
            THAT STAND OUT
          </h1>
